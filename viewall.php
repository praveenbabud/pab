...
while ($tindex < $index)
{
	...
	if ($tid == 0)
	{
		...
		echo "<br><br><span class=\"boldatp\" onmouseover=\"this.style.cursor='pointer';\" onclick=\"getData('browse','browse=$bs')\">$name[$tindex]</span><br><br>";
	}
	else if ($tid == 1)
	{
		$bs = str_replace(" ","-",$name[$tindex]);
		echo "<span class=\"ublueatp\" onmouseover=\"this.style.cursor='pointer';\" onclick=\"getData('browse','browse=$bs')\">$name[$tindex]</span><br>";
	}
	$tindex = $tindex + 1;
	$kc = $kc + 1;
}
