...
function addbook($link, $isbn13, $title, $edition , $yearofprint, $author1, $author2, $author3, $author4, $publisher,$blurb,$listprice, $ourprice,$shiptime,$pages)
{
	...
	$db_result = mysqli_query($link,$db_query);
	 $lyear = strtolower($yearofprint);

	if (strstr($yearofprint,"2010") != null)
	{
		if (strstr($lyear, "sep") != null || strstr($lyear, "oct") != null || strstr($lyear, "nov") != null)
...
function buildindex($link, $isbn13, $title, $edition , $yearofprint, $author1, $author2, $author3, $author4, $publisher,$blurb,$listprice, $ourprice,$vipkeys)
{
	$index = 0;
	$weight = 25;
	if (strstr($yearofprint,"2010") != null)
		$weight = 30;
	else if (strstr($yearofprint,"2009") != null)
		$weight = 25;
	else
		$weight = 10;
...
$keylines = file("randombooks-6-sep-2010.data");
...
foreach($keylines as $line)
{
		...
		if ($param == "###")
		{
			...
			{
				if ($publisher == "Random House India Random House")
			...
			buildindex($link, $isbn13, $title, $edition , $yearofprint, $author1, $author2, $author3, $author4, $publisher,$blurb,$lp, $op,$vipkeys); 
			$value = "";
			$isbn13 = $value;
			$title = $value;
			$isbn10 = $value;
