		...
		else
		{
			...
			if ($db_result == TRUE)
			{
				...
				if ($num_rows > 0)
				{
 				...
 				$output = $output . "</td></tr><tr><td>&nbsp;</td><td align=\"left\" valign=\"top\"><img alt=\"$db_row[0]\" title=\"$db_row[0]\" src=\"https://www.popabook.com/optimage/$image\" width=\"70px\" height=\"100px\"/></td><td valign=\"top\" class=\"atp\"> ";
				...
				else
				{
					...
					else
					{
						...
						if ($db_row[10] == 1)
							$output = $output . "<div class=\"pabborder\"></div><div style=\"text-align:left;padding-left:10px;\"><h3><br>Book Overview: $db_row[0] </h3><br><br><span class=\"atp\">$db_row[13]</span></div><div style=\"text-align:right\"><a class=\"blueatp\" href=\"#\">Top</a></div>";
						...
						$output = $output . "<div class=\"pabborder\"></div><div style=\"text-align:left;padding-left:10px;\"><br><h3>Image of Book : $db_row[0]</h3><br><br> <img src=\"https://www.popabook.com/$imagelarge\" title=\"$db_row[0]\" alt=\"$db_row[0]\" width=\"140px\" height=\"200px\"></div><div style=\"text-align:right\"><a class=\"blueatp\" href=\"#\">Top</a></div></div>";
						$output = $output . "<div style=\"text-align:center\"><h3>Book : $db_row[0]</h3><h4> <br>by $db_row[1] <br>ISBN:$db_row[2]</h4></div>";
							
					}
                                        $metadata =  "<meta name=\"keywords\" content=\"$db_row[0] : $db_row[1] ISBN:$db_row[2]\">" . "<meta name=\"Description\" content=\"Buy $db_row[0] : $db_row[1] ListPrice: $db_row[3] and OurPrice: $db_row[4]";
			        if ($savepercent > 0)
					$metadata = $metadata . " Save($savepercent%)";
				$metadata = $metadata . " + FREE Shipping Book Overview Similar Books Used Books\">";
				$metadata = $metadata . "<link rel=\"canonical\" href=\"https://www.popabook.com/$booklink\"/>";
					$title = "<title>$db_row[0] : $db_row[1] : Books : PopAbooK.com India</title>";
		...
		if ($db_result == TRUE)
		{
			...
			if ($db_row != null)
			{
				...
				if ($seo == 1)
 				...
 				$output = $output . "</td></tr><tr><td>&nbsp;</td><td align=\"left\" valign=\"top\"><img alt=\"$db_row[0]\" src=\"https://www.popabook.com/optimage/$image\" width=\"70px\" height=\"100px\"/></td><td valign=\"top\" class=\"atp\"> ";
				$output = $output . " by <span class=\"boldatp\"><b>";
				if ($db_row[1] != "")
				{
					$output = $output . $db_row[1];
...
function showsimilarbooksonpage($link,$bookid,$seo)
{
	...
	$output = $output . "<div class=\"logoatp\" style=\"text-align:center;color:#000000;\">Similar Books</div>";
				...
				$output = $output . "<br><table width=\"100%\"><tr><td>&nbsp;</td><td colspan=\"3\" class=\"atp\" align=\"left\">";
 				...
 				$output = $output . "</td></tr><tr><td>&nbsp;</td><td align=\"left\" valign=\"top\"><img title=\"$db_row[0]\" alt=\"$db_row[0]\" src=\"https://www.popabook.com/optimage/$image\" width=\"70px\" height=\"100px\"/></td><td valign=\"top\" class=\"atp\"> ";
				$output = $output . " by <span class=\"boldatp\"><b>";
				if ($db_row[1] != "")
				{
					$output = $output . $db_row[1];
