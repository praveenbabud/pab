...
function getaddress(disableconfirm)
{
	...
	var thehtml = "<div id=\"adform\" class=\"atp\" style=\"padding-left:200px;width:500px\"> <form id=\"addressform\" method=\"POST\" action=\"https://secure.ebs.in/pg/ma/sale/pay/\"> <p class=\"logoatp\"> <br>Shipping Address Please </p>" + 
		        "<input name=\"account_id\" type=\"hidden\" value=\"6116\">  <input name=\"return_url\" type=\"hidden\" value=\"https://www.popabook.com/response.php?DR={DR}\" /> <input name=\"mode\" type=\"hidden\" value=\"LIVE\"/> <input name=\"reference_no\" type=\"hidden\" value=\"empty\"/> <input name=\"amount\" type=\"hidden\" value=\"empty\"/> <input name=\"description\" type=\"hidden\" /> <input name=\"name\" type=\"hidden\"/><input name=\"address\" type=\"hidden\"/> <input name=\"city\" type=\"hidden\"/>  <input name=\"postal_code\" type=\"hidden\"/> <input name=\"phone\" type=\"hidden\"/> <input name=\"state\" type=\"hidden\"/> <input name=\"country\" type=\"hidden\"/>"+ "<table><tr><td>Name* </td>" + "<td><input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_name\" type=\"text\" value=\"" + name + "\" />" + "</td></tr>" + "<tr><td> Address* </td>" + "<td> <textarea name=\"ship_address\" rows=\"3\" >" + address + "</textarea> </td></tr>" + "<tr><td> City/District* </td> <td>  <input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_city\" type=\"text\" value=\"" + city + "\"/></td></tr>" +  "<tr><td> PinCode* </td> <td>    <input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_postal_code\" type=\"text\" value=\"" + pincode + "\"/> </td></tr> " +  "<tr><td>Telephone* </td> <td> <input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_phone\" type=\"text\" value=\"" + telephone + "\"/> </td> </tr> " + " <tr><td>E-Mail* </td>";
	if (email != "")
...
function loading()
{
    ...
    var thehtml = "<div style=\"text-align:left;position:absolute;top:200px;left:" + width + "px;width:33px;height:33px;\"><img src=\"https://www.popabook.com/loading.gif\"></div>";
