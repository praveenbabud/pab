...
if (isset($_POST['search_string']) == TRUE)
{
	...
	if ($title == "")
		echo "<title>PopAbooK.com : Online Book Store. Buy Books Online in India.</title>";
	else
		echo "$title";
	if ($metadata == "")
	{
		...
		echo "<meta name=\"Description\" content=\"Buy Books Online in India. \">";
	}
	else
        {
                echo "<meta http-equiv=\"X-UA-Compatible\" content=\"IE=EmulateIE7\" />";
...
$xid = rawurlencode("http://www.popabook.com/$storeurl");
echo "<div style=\"padding-top:3px;padding-bottom:3px;\"><table><tr><td valign=\"top\"><iframe src=\"http://www.facebook.com/plugins/like.php?href=$xid&amp;layout=button_count&amp;show_faces=false&amp;width=125&amp;action=like&amp;font=verdana&amp;colorscheme=light&amp;height=21\" scrolling=\"no\" frameborder=\"0\" style=\"border:none; overflow:hidden; width:125px; height:21px;\" allowTransparency=\"true\"></iframe></td><td valign=\"top\"><iframe allowtransparency=\"true\" frameborder=\"0\" scrolling=\"no\" src=\"http://platform.twitter.com/widgets/tweet_button.html?url=$xid&via=PopAbooK&text=Checking%20out%20$storename&related=popabook%3ASocial%20Book%20Store&count=horizontal\" style=\"width:130px; height:21px;\"></iframe></td><td valign=\"top\"><iframe allowtransparency=\"true\" frameborder=\"0\" scrolling=\"no\" src=\"http://www.popabook.com/gbb.php?url=$xid&title=$storename\" style=\"border:none;overflow:hidden;width:150px;height:21px;\"></iframe></td></tr></table></div>";
}
else
...
{
        echo "<div style=\"clear:both;width:970px;text-align:left;\">";
        echo "<div class=\"logoatp\" style=\"text-align:left;width:610px;float:right;padding-top:0px;\">"        ;
        echo "<table><tr><td valign=\"top\">Search Books:</td><td valign=\"top\">";
        ...
        echo "<div class=\"logoatp\" style=\"width:300px;text-align:left;padding-left:50px;padding-top:20px;\">";
...
<div id="rightsidecart"></div><div id="promotions"></div>
</div>
...
<script type="text/javascript" src="http://www.popabook.com/pabdpv1.js"></script>
<div id="fb-root"></div>
<script>
