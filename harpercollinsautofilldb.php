...
$keylines = file("sep-18-2010-harper-collins-books.data");
...
foreach($keylines as $line)
{
		...
		if ($param == "###" && $isbn13 == "9789350290019")
		{
			$t = strstr($listprice, "pound");
			if (strstr($listprice, "pound") != null)
				$currency = "P";
			else if (strstr($listprice, "Rs.") != null)
				$currency = "R";
			else
