...
function allowlogin(signin,useremail,userpassword)
{
    ...
    thehtml = thehtml + "<div> <img src=\"https://www.popabook.com/signin.jpg\" onmouseover=\"this.style.cursor='pointer';\" onclick=\"processloginform()\"></div></form>";
	}
	else
	{
    ...
    thehtml = thehtml + "<div> <img src=\"https://www.popabook.com/login.jpg\" onmouseover=\"this.style.cursor='pointer';\" onclick=\"processloginform()\"></div></form>";
	}
...
function getaddress(disableconfirm)
{
	...
	{
              thehtml = thehtml + "<table width=\"90%\"> <tr> <td><div> <img src=\"https://www.popabook.com/pw.jpg\"></div></td></tr><tr><td class=\"satp\"><br>By clicking on Confirm & Pay button above, you agree to PopAbooK.com Terms and Conditions and agree to have read and understood the Privacy Policy.</td></tr></table>" + "</form> </div>";
	}	
	else
	{
		thehtml = thehtml +"<table width=\"90%\"> <tr> <td><div><a href=\"javascript:void(0)\"><img src=\"https://www.popabook.com/buttoncp.jpg\" style=\"color:#ffffff;\"  onclick=\"confirmorder()\"></a></div></td></tr><tr><td class=\"satp\"><br>By clicking on Confirm & Pay button above, you agree to PopAbooK.com Terms and Conditions and agree to have read and understood the Privacy Policy.</td></tr></table>" + "</form> </div>"; 
	}
	cartdiv.innerHTML = thehtml;
...
function getsimilarbooks(isbn13)
{
   getData1("getsimilarbooks", "isbn13=" + isbn13);
	...
	blurbdata.innerHTML = "<br><br>Please Wait ...<br><br>";
}
...
function showcart()
{
    ...
    if (items > 0)
    {
		...
		if (temp.length == 2)
			...
			thehtml = thehtml + "<td>" + "<img height=\"100px\" width=\"70px\" src=\"https://www.popabook.com/optimage/" + curr.data.image + "\" title=\"" + curr.data.title + sellinfo + "\"  onmouseover=\"this.style.cursor='pointer';\" onclick=\"highgetData('search','" + isbn + "')\">" + "</td>" + "<td style=\"text-decoration:line-through\" > " + lp + "</td>" + "<td>" + op + "</td>" + "<td>" +
...
function showwishlist()
{
    ...
    if (items > 0)
    {
		...
		isbn = curr.data.isbn13;
				...
				thehtml = thehtml + "<tr>";
			thehtml = thehtml + "<td>" + "<img height=\"100px\" width=\"70px\" src=\"https://www.popabook.com/optimage/" + curr.data.image + "\" title=\"" + curr.data.title + "\"  onmouseover=\"this.style.cursor='pointer';\" onclick=\"highgetData('search','" + isbn + "')\">" + "</td>" + "<td style=\"text-decoration:line-through\" > " + lp + "</td>" + "<td>" + op + "</td><td>";
...
function process_confirmorderdata_xml_response(xmldocument, htmlresponse)
{
	...
	{
           var er = document.createTextNode("We are Sorry. We could not process your order. Please try again");
