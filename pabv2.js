...
function getsimilarbooks(isbn13)
{
   getData1("getsimilarbooks", "isbn13=" + isbn13);
	...
	{
		headertxt = headertxt + "<a id=\"" + isbn13 + "usedbooks\" class=\"blueatp\" onclick=\"getusedbooks('" + isbn13 + "')\">" + ubcount + "</a></td></tr></table>";
	}
...
function showcart()
{
	...
	shipcost = 0;
		...
		{
			thehtml = thehtml + "<br> &nbsp;<span class=\"atp\">Shipping Cost Rs. </span> 30";
			tlp = tlp + 30; total = total + 30;
			shipcost = 30;
		}
    var usave = tlp - total;
