         ...
         if (XMLHttpRequestObject)
         {
			 if (req == "home")
			 {
                 ...
                 XMLHttpRequestObject.onreadystatechange = function()
                 {
                	...
                	XMLHttpRequestObject.send(storeurl + linkurl);
			 }
				...
				XMLHttpRequestObject.open("POST",testbase + "getusedbooks.php");
                   ...
                   XMLHttpRequestObject.onreadystatechange = function()
                   {
                           ...
                           XMLHttpRequestObject.status == 200)
                       {
                        ...
                        else if (req == "magnifybook")
                        {
                                XMLHttpRequestObject.open("POST",testbase + "magnifybook.php");
                   XMLHttpRequestObject.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                   XMLHttpRequestObject.onreadystatechange = function()
                   {
                       if (XMLHttpRequestObject.readyState == 4 &&
                           XMLHttpRequestObject.status == 200)
                       {
                            getmagnifybookresponse(reqdata,XMLHttpRequestObject.responseText);
                            delete XMLHttpRequestObject;
                            XMLHttpRequestObject = null;
                       }
                   }
                   ...
                   XMLHttpRequestObject.onreadystatechange = function()
                   {
                           ...
                           XMLHttpRequestObject.status == 200)
                       {
                        ...
                        else if (req == "verifydiscountcoupon")
                        {
                                XMLHttpRequestObject.open("POST",testbase + "verifydiscountcoupon.php");
                   XMLHttpRequestObject.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                   XMLHttpRequestObject.onreadystatechange = function()
                   {
                       if (XMLHttpRequestObject.readyState == 4 &&
                           XMLHttpRequestObject.status == 200)
                       {
                            verifydiscountcoupon_response(XMLHttpRequestObject.responseText);
                            delete XMLHttpRequestObject;
                            XMLHttpRequestObject = null;
                       }
                   }
...
function getusedbooks(isbn13)
{
	...
	var headertxt = "<br><table width=\"100%\"> <tr><td width=\"20%\">&nbsp;&nbsp;";
...
function getreviews(isbn13)
{
	...
	var usedbooks;
        ...
        if (storeurl == "")
        {
           header = document.getElementById(isbn13 + "header");
	   usedbooks = document.getElementById(isbn13 + "usedbooks");
	   ubcount = usedbooks.innerHTML;
        }
	var bookoverview = document.getElementById(isbn13 + "overview");
	var headertxt = "";
        if (storeurl != "")
        {
	headertxt = "<br><table width=\"100%\"> <tr><td width=\"33%\">&nbsp;&nbsp;";
	if (bookoverview != null)
		headertxt = headertxt + "<a id=\"" + isbn13 + "overview\" href=\"javascript:void(0)\" onclick=\"getblurb('" + isbn13 + "')\" class=\"blueatp\">Read Overview</a>&nbsp;</td>";
	else
		headertxt = headertxt + "&nbsp;</td>";
	headertxt = headertxt + "<td width=\"33%\" align=\"center\"><a href=\"javascript:void(0)\" onclick=\"closeblurb('" + isbn13 + "')\">Hide Reviews</a></td><td width=\"33%\" align=\"right\"><a href=\"javascript:void(0)\" onclick=\"getviewallbook('" + isbn13 + "')\">View All</a></td></tr></table>";
        }
        else
        {
	headertxt = "<br><table width=\"100%\"> <tr><td width=\"20%\">&nbsp;&nbsp;";
	if (bookoverview != null)
		headertxt = headertxt + "<a id=\"" + isbn13 + "overview\" href=\"javascript:void(0)\" onclick=\"getblurb('" + isbn13 + "')\" class=\"blueatp\">Read Overview</a>&nbsp;</td>";
	else
		headertxt = headertxt + "&nbsp;</td>";
...
function getviewallbook(isbn13)
{
	...
	if (bookoverview != null)
		...
		headertxt = headertxt + "&nbsp;</td>";
	headertxt = headertxt + "<td width=\"33%\" align=\"center\"><a href=\"javascript:void(0)\" onclick=\"getreviews('" + isbn13 + "')\">Friend's Reviews</a></td><td width=\"33%\" align=\"right\"> <a href=\"javascript:void(0)\" onclick=\"closeblurb('" + isbn13 + "')\">Hide All</a>&nbsp;</td></tr></table>";
        }
        else
        {
...
function doitonload()
{
	/*loadleftdata(); */
        if ("https:" == document.location.protocol)
            testbase = "https://www.popabook.com/";
        else
            testbase = "http://www.popabook.com/";
...
function getaddress(disableconfirm)
{
	...
	var thehtml = "<div id=\"adform\" class=\"atp\" style=\"padding-left:200px;width:500px\"> <form id=\"addressform\" method=\"POST\" action=\"https://secure.ebs.in/pg/ma/sale/pay/\"> <p class=\"logoatp\"> <br>Shipping Address Please </p>" + "<input name=\"account_id\" type=\"hidden\" value=\"6116\">  <input name=\"return_url\" type=\"hidden\" value=\"http://www.popabook.com/response.php?DR={DR}\" /> <input name=\"mode\" type=\"hidden\" value=\"LIVE\"/> <input name=\"reference_no\" type=\"hidden\" value=\"empty\"/> <input name=\"amount\" type=\"hidden\" value=\"empty\"/> <input name=\"description\" type=\"hidden\" /> <input name=\"name\" type=\"hidden\"/><input name=\"address\" type=\"hidden\"/> <input name=\"city\" type=\"hidden\"/>  <input name=\"postal_code\" type=\"hidden\"/> <input name=\"phone\" type=\"hidden\"/> <input name=\"state\" type=\"hidden\"/> <input name=\"country\" type=\"hidden\"/>"+ "<table><tr><td>Name* </td>" + "<td><input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_name\" type=\"text\" value=\"" + name + "\" />" + "</td></tr>" + "<tr><td> Address* </td>" + "<td> <textarea name=\"ship_address\" rows=\"3\" >" + address + "</textarea> </td></tr>" + "<tr><td> City/District* </td> <td>  <input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_city\" type=\"text\" value=\"" + city + "\"/></td></tr>" +  "<tr><td> PinCode* </td> <td>    <input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_postal_code\" type=\"text\" value=\"" + pincode + "\"/> </td></tr> " +  "<tr><td>Telephone* </td> <td> <input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_phone\" type=\"text\" value=\"" + telephone + "\"/> </td> </tr> " + " <tr><td>E-Mail* </td>";
	if (email != "")
	 ...
	 /*      thehtml = thehtml + "<br><br><input type=\"radio\" name=\"paytype\" value=\"cash\" checked>Pay Cash On Delivery<br><br>";*/
      ...
      thehtml = thehtml + "<table width=\"100%\"><tr><td>";
      /* <input type=\"radio\" name=\"paytype\" value=\"cash\">Pay Cash On Delivery<br><br>";*/
       ...
       thehtml = thehtml + "<td> <table cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td><a href=\"http://www.ebs.in/\" target=\"_blank\"><img src=\"http://www.popabook.com/EBS_Flasher1.gif\" title=\"EBS\" border=\"0\"></a></td></tr></table></td></tr></table>";
        ...
        {
             window.scrollTo(0,0);
                thehtml = thehtml +"<table width=\"90%\"> <tr> <td><div><a href=\"javascript:void(0)\"><img alt=\"Confirm & Pay\" title=\"Confirm & Pay\" src=\"http://www.popabook.com/tbuttoncp.jpg\" onclick=\"confirmorder('online')\"></a></div></td></tr><tr><td class=\"satp\"><br>By clicking on Confirm & Pay button above, you agree to PopAbooK.com Terms and Conditions and agree to have read and understood the Privacy Policy.</td></tr></table>" + "</form>";
                thehtml = thehtml + "<div id=\"discountcoupon\"><form id=\"discountcouponform\" onsubmit=\"return false;\"><table width=\"100%\"><tr><td>Promotion Coupon Code!?</td><td><input type=\"text\" name=\"discountcouponvalue\"></td><td><span onmousedown=\"this.style.backgroundColor='#00008b';\" class=\"atp\" style=\"border:solid 1px #0000ff;padding-top:2px;padding-bottom:2px;background-color:#2b60de;color:#ffffff;\" onmouseover=\"this.style.backgroundColor='#0000ff';this.style.color='#ffffff';this.style.cursor='pointer';\" onmouseout=\"this.style.backgroundColor='#2b60de';this.style.color='#ffffff';\" onclick=\"verifydiscountcoupon()\">&nbsp;Apply Coupon&nbsp;</span></td></tr></table></form></div>";
                thehtml = thehtml + "<div id=\"pabcard\"><form id=\"pabcardform\" onsubmit=\"return false;\"><div class=\"logoatp\"><hr><br>Pay Using pabCard</div><br><table width=\"100%\"><tr><td>pabCard Number*</td><td><input type=\"text\" name=\"pabcardnumber\"></td></tr><tr><td colspan=\"2\"><br><br><a onmousedown=\"this.style.backgroundColor='#00008b';\" class=\"logoatp\" style=\"text-decoration:none;border:solid 1px #0000ff;padding-top:5px;padding-bottom:5px;background-color:#2b60de;color:#ffffff;\" onmouseover=\"this.style.backgroundColor='#0000ff';this.style.color='#ffffff';this.style.cursor='pointer';\" onmouseout=\"this.style.backgroundColor='#2b60de';this.style.color='#ffffff';\" href=\"#\" onclick=\"verifypabcard()\">&nbsp;Pay Using pabCard&nbsp;</a></td></tr></table></form></div>";
                thehtml = thehtml + "</div>";
        }
...
function getblurb(isbn13)
{
	...
	var header = document.getElementById(isbn13 + "header");
	   ...
	   ubcount = usedbooks.innerHTML;
        ...
        if (storeurl != "")
        {
		var headertxt = "<br><table width=\"100%\"> <tr><td width=\"33%\">&nbsp;&nbsp;<a id=\"" + isbn13 + "overview\" href=\"javascript:void(0)\" onclick=\"closeblurb('" + isbn13 + "')\" class=\"blueatp\">Hide Overview</a></td><td width=\"33%\" align=\"center\"><a href=\"javascript:void(0)\" onclick=\"getreviews('" + isbn13 + "')\">Friend's Reviews</a></td><td width=\"33%\" align=\"right\"><a href=\"javascript:void(0)\" onclick=\"getviewallbook('" + isbn13 + "')\">View All</a>&nbsp;&nbsp;</td></tr></table>";
        }
        else
        {
	var headertxt = "<br><table width=\"100%\"> <tr><td width=\"20%\">&nbsp;&nbsp;<a id=\"" + isbn13 + "overview\" href=\"javascript:void(0)\" onclick=\"closeblurb('" + isbn13 + "')\" class=\"blueatp\">Hide Overview</a></td><td width=\"20%\" align=\"center\"><a href=\"javascript:void(0)\" onclick=\"getreviews('" + isbn13 + "')\">Friend's Reviews</a></td><td width=\"20%\" align=\"center\"> <a href=\"javascript:void(0)\" onclick=\"getsimilarbooks('" + isbn13 + "')\">Similar Books</a></td><td width=\"20%\" align=\"center\">";
	if (ubcount == "0 Used Books")
	{
		headertxt = headertxt + "<span id=\"" + isbn13 + "usedbooks\" class=\"blueatp\">0 Used Books</span></td>";
	}
...
function closeblurb(isbn13)
{
	...
	if (bookoverview != null)
		...
		headertxt = headertxt + "&nbsp;</td>";
        headertxt = headertxt + "<td width=\"33%\" align=\"center\"><a href=\"javascript:void(0)\" onclick=\"getreviews('" + isbn13 + "')\">Friend's Reviews</a></td><td width=\"33%\" align=\"right\"><a href=\"javascript:void(0)\" onclick=\"getviewallbook('" + isbn13 + "')\">View All</a>&nbsp;&nbsp;</td></tr></table>";
        }
        else
        {
...
function getData1(req,reqdata,docpart)
{
         ...
         if (XMLHttpRequestObject)
         {
			 ...
			 else if (req == "getsimilarbooks")
			 {
                ...
                XMLHttpRequestObject.send("reqtype=" + req + "&" + reqdata + linkurl + storeurl);
			 }
			 }
}
...
function showcart()
{
    ...
    while (curr != null)
    {
		...
		if (temp.length == 2)
                {
	            couponprice = couponprice + parseInt(curr.data.ourprice) * parseInt(curr.data.quantity);
                }
                else if (temp.length == 1)
                {
                     var cpb = (100 - discountpercent) * parseInt(curr.data.listprice);
                     cpb = parseInt(cpb/100);
                     if (cpb < parseInt(curr.data.ourprice))
                     {
	                   couponprice = couponprice + cpb * parseInt(curr.data.quantity);
                     }
                     else
                     {
	                   couponprice = couponprice + parseInt(curr.data.ourprice) * parseInt(curr.data.quantity);
    ...
    if (items > 0)
    {
		...
		if (temp.length == 2)
			...
			thehtml = thehtml + "<td>" + "<img height=\"100px\" width=\"70px\" src=\"http://www.popabook.com/optimage/" + curr.data.image + "\" title=\"" + curr.data.title + sellinfo + "\"  onmouseover=\"this.style.cursor='pointer';\" onclick=\"getsearchdata('getbook','search_string=book/" + isbn + "')\">" + "</td>" + "<td style=\"text-decoration:line-through\" > " + lp + "</td>" + "<td>" + op + "</td>" + "<td>" +
    ...
    var usave = tlp - total;
		...
		if (usave > 0)
		{
			...
			thehtml = thehtml +  "<br> &nbsp;<span class=\"atp\">You Save Rs. </span>" + usave + "(" +savep + "%)";
                ...
                pab_ordertotal = total;
                if (couponprice != 0)
                {
                    couponprice = couponprice + shipcost;
                    usave = tlp - couponprice;
		    thehtml = thehtml + "<br><br><div class=\"pabborder\"></div><br><span class=\"boldatp\">New Promotional Price</span><br><br>&nbsp;<span class=\"atp\">Total is Rs. <s>" + tlp + "</s>&nbsp;</span>" + couponprice;
		if (usave > 0)
		{
			var savep = parseInt((usave * 100)/tlp);
			thehtml = thehtml +  "<br> &nbsp;<span class=\"atp\">You Save Rs. </span>" + usave + "(" +savep + "%)";
		}
                pab_ordertotal = couponprice;
                }
...
function showwishlist()
{
    ...
    if (items > 0)
    {
		...
		isbn = curr.data.isbn13;
				...
				thehtml = thehtml + "<tr>";
			thehtml = thehtml + "<td>" + "<img height=\"100px\" width=\"70px\" src=\"http://www.popabook.com/optimage/" + curr.data.image + "\" title=\"" + curr.data.title + "\"  onmouseover=\"this.style.cursor='pointer';\" onclick=\"getsearchdata('getbook','search_string=book/" + isbn + "')\">" + "</td>" + "<td style=\"text-decoration:line-through\" > " + lp + "</td>" + "<td>" + op + "</td><td>";
...
function confirmorder(cashoronline)
{
...
function getData2(req,reqdata,docpart)
{
         ...
         if (XMLHttpRequestObject)
         {
		   ...
		   XMLHttpRequestObject.send("reqtype=" + req + "&" + getorderstring() + "&" +getaddressstring() + "&shipcost=" + shipcost + "&total=" + pab_ordertotal + "&coupon=" + coupon + "&pcn=" + pcn);
...
function process_confirmorderdata_xml_response(xmldocument, htmlresponse)
{
	...
	if (paymode == "cash")
	{
		centerdata.innerHTML = htmlresponse;
                if (htmlresponse.indexOf('Invoice Number') > 0)
		clearrightside();
		return;
	}
	...
	if (responsevalue == "success")
	{
		...
		var orderid = xmldocument.getElementsByTagName("orderid")[0].childNodes[0].nodeValue;
			if (paymode == "online")
			{
				...
				af.amount.value = pab_ordertotal;
    		...
    		var msg = xmlresp.getElementsByTagName("message")[0].childNodes[0].nodeValue;
                if (msg.indexOf("Out Of Stock;") == 0)
                {
	   			...
	   			var crdata = "Book : " + curr.data.title;
                                ...
                                {
                                    crdata = crdata + " has just gone Out Of Stock few seconds ago. We have updated the shopping cart accordingly. Please verify and proceed to bill.";
                                }
...
{
	getsearchdata('search', 'search_string=' + cat);
	unbrowse();
	window.scrollTo(0,0);
}
function bbbrowse(cat)
{
	getsearchdata('browse', 'browse=' + cat);
	unbrowse();
	window.scrollTo(0,0);
}
...
function verifydiscountcoupon()
{
    var dcform = document.getElementById("discountcouponform");
    var dc = "";
    if (dcform != null)
    {
         dc = dcform.elements[0].value;
    }
    if (dc == "")
       return;
    getData("verifydiscountcoupon", "dc=" + dc);
    coupon = dc;
    var dcdiv = document.getElementById("discountcoupon");
    dcdiv.innerHTML  = dcdiv.innerHTML + "<div style=\"text-align:center;\"><img src=\"http://www.popabook.com/loading.gif\"></div>";
   
}
function verifydiscountcoupon_response(response)
{
    var dc = document.getElementById("discountcoupon");
    var valid = response.indexOf("Congratulations", 0);
    if (valid != -1)
    {
    if (response.indexOf("[5%]") >= 0)
        discountpercent = 5;
    else if (response.indexOf("[10%]") >= 0)
        discountpercent = 10;
    else if (response.indexOf("[12%]") >= 0)
        discountpercent = 12;
    else if (response.indexOf("[20%]") >= 0)
        discountpercent = 20;
    else if (response.indexOf("[15%]") >= 0)
        discountpercent = 15;
    else if (response.indexOf("[16%]") >= 0)
        discountpercent = 16;
    else if (response.indexOf("[17%]") >= 0)
        discountpercent = 17;
    else if (response.indexOf("[18%]") >= 0)
        discountpercent = 18;
    else if (response.indexOf("[19%]") >= 0)
        discountpercent = 19;
    else if (response.indexOf("[21%]") >= 0)
        discountpercent = 21;
    else if (response.indexOf("[22%]") >= 0)
        discountpercent = 22;
    else if (response.indexOf("[23%]") >= 0)
        discountpercent = 23;
    else if (response.indexOf("[24%]") >= 0)
        discountpercent = 24;
    else if (response.indexOf("[25%]") >= 0)
        discountpercent = 25;
    else if (response.indexOf("[30%]") >= 0)
        discountpercent = 30;
    else
        discountpercent = 0;
    }
    if (discountpercent != 0)
            showcart();
    if (dc != null)
        dc.innerHTML = response;
}
function verifypabcard()
{
    var pcform = document.getElementById("pabcardform");
    if (pcform != null)
    {
        pcn = pcform.elements[0].value;
        if (pcn != "")
        {
              confirmorder('cash');
        }
...
function magnifybook(isbn13)
{
    getData('magnifybook','isbn13=' + isbn13);
    getviewallbook(isbn13);
}
function getmagnifybookresponse(reqdata,responsetext)
{
           var temp = new Array();
           temp = reqdata.split('=');
	
	   var mainbook = document.getElementById(temp[1] + "main");
           mainbook.innerHTML = responsetext;
}
