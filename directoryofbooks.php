...
if (isset($_POST['search_string']) == TRUE)
{
 ...
 $pagetitle = "";
 $doblinks = directoryofbooks($link,$pagetitle);
	if ($pagetitle == "")
		   ...
		   if ($db_result1 == TRUE)
		   {
			   ...
			   if ($db_row1 != null)
			   {
				   ...
				   if (file_exists("/var/apache2/2.2/htdocs/optimage/" . $db_row[1] . ".jpg"))
				   	...
				   	echo "addtocartonload('ina.jpg'," . $listprice . ",$ourprice,'" . $db_row[1] . "',\"$db_row1[0]\",$db_row[0],'$db_row1[3]');";
...
<?php
if ($storename != "")
echo "padding-top:5px;\"><a  class=\"logoatpo\" style=\"text-decoration:none;font-size:xx-large;\" href=\"http://www.popabook.com/$storeurl/bookstore\">$storename</a>";
else
...
<div class="pabheadingbackground" style="text-align:left;width:715px;text-align:left;">
