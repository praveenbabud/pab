var name = "";
var testbase = "https://www.popabook.com/";
var email = "";
var city = "";
var state = "";
var pincode = "";
...
productsids[0] = 0;
products[1] = 'Higher Education';
productsids[1] = 1;
products[2] = 'Competitive Exams';
productsids[2] = 2;
...
function allowlogin(signin,useremail,userpassword)
{
    ...
    thehtml = thehtml + "<div> <a href=\"javascript:void(0)\" onclick=\"processloginform()\"><img src=\"https://www.popabook.com/signin.jpg\"></a></div></form>";
	}
	else
	{
    ...
    thehtml = thehtml + "<div> <a href=\"javascript:void(0)\" onclick=\"processloginform()\"><img src=\"https://www.popabook.com/login.jpg\"></a></div></form>";
	}
...
function getusedbooks(isbn13)
{
	...
	var headertxt = "<table width=\"100%\"> <tr><td width=\"33%\">&nbsp;";
	...
	headertxt = headertxt + "<td width=\"33%\" align=\"center\"> <a href=\"javascript:void(0)\" onclick=\"getsimilarbooks('" + isbn13 + "')\">Similar Books</a></td><td width=\"34%\" align=\"right\">";
		headertxt = headertxt + "<a href=\"javascript:void(0)\" id=\"" + isbn13 + "usedbooks\" class=\"blueatp\" onclick=\"closeblurb('" + isbn13 + "')\">Hide " + ubcount + "</a></td></tr></table>";
...
{
	/* var browselink = document.getElementById("browselink");
	browselink.innerHTML = "<a href=\"javascript:void(0);\"  onclick=\"unbrowse();getData('browse','browse=browseall')\" style=\"color:#ffffff;\">Browse Books</a>&nbsp;<img src=\"https://www.popabook.com/dd.jpg\" onmouseover=\"this.style.cursor='pointer';starttimer()\" onmouseout=\"stoptimer()\">";
...
function getaddress(disableconfirm)
{
	...
	var thehtml = "<div id=\"adform\" class=\"atp\" style=\"padding-left:200px;width:500px\"> <form id=\"addressform\" method=\"POST\" action=\"https://secure.ebs.in/pg/ma/sale/pay/\"> <p class=\"logoatp\"> <br>Shipping Address Please </p>" + 
		        "<input name=\"account_id\" type=\"hidden\" value=\"6116\">  <input name=\"return_url\" type=\"hidden\" value=\"https://www.popabook.com/response.php?DR={DR}\" /> <input name=\"mode\" type=\"hidden\" value=\"TEST\"/> <input name=\"reference_no\" type=\"hidden\" value=\"empty\"/> <input name=\"amount\" type=\"hidden\" value=\"empty\"/> <input name=\"description\" type=\"hidden\" /> <input name=\"name\" type=\"hidden\"/><input name=\"address\" type=\"hidden\"/> <input name=\"city\" type=\"hidden\"/>  <input name=\"postal_code\" type=\"hidden\"/> <input name=\"phone\" type=\"hidden\"/> <input name=\"state\" type=\"hidden\"/> <input name=\"country\" type=\"hidden\"/>"+ "<table><tr><td>Name* </td>" + "<td><input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_name\" type=\"text\" value=\"" + name + "\" />" + "</td></tr>" + "<tr><td> Address* </td>" + "<td> <textarea name=\"ship_address\" rows=\"3\" >" + address + "</textarea> </td></tr>" + "<tr><td> City/District* </td> <td>  <input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_city\" type=\"text\" value=\"" + city + "\"/></td></tr>" +  "<tr><td> PinCode* </td> <td>    <input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_postal_code\" type=\"text\" value=\"" + pincode + "\"/> </td></tr> " +  "<tr><td>Telephone* </td> <td> <input onKeyPress=\"checkEnter(event,'confirm',this.form)\" name=\"ship_phone\" type=\"text\" value=\"" + telephone + "\"/> </td> </tr> " + " <tr><td>E-Mail* </td>";
	if (email != "")
	 ...
	 /*      thehtml = thehtml + "<br><br><input type=\"radio\" name=\"paytype\" value=\"cash\" checked>Pay Cash On Delivery<br><br>";*/
      ...
      /* <input type=\"radio\" name=\"paytype\" value=\"cash\">Pay Cash On Delivery<br><br>";*/
       ...
       thehtml = thehtml + "<td> <table cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td><a href=\"http://www.ebs.in/\" target=\"_blank\"><img src=\"https://www.popabook.com/EBS_Flasher1.gif\" title=\"EBS\" border=\"0\"></a></td></tr></table></td></tr></table>";
	if (disableconfirm == true)
	{
              thehtml = thehtml + "<table width=\"90%\"> <tr> <td><div> <img alt=\"Please Wait ...\" src=\"https://www.popabook.com/pw.jpg\"></div></td></tr><tr><td class=\"satp\"><br>By clicking on Confirm & Pay button above, you agree to PopAbooK.com Terms and Conditions and agree to have read and understood the Privacy Policy.</td></tr></table>" + "</form> </div>";
	}	
	else
	{
		thehtml = thehtml +"<table width=\"90%\"> <tr> <td><div><a href=\"javascript:void(0)\"><img alt=\"Confirm & Pay\" src=\"https://www.popabook.com/buttoncp.jpg\" style=\"color:#ffffff;\"  onclick=\"confirmorder()\"></a></div></td></tr><tr><td class=\"satp\"><br>By clicking on Confirm & Pay button above, you agree to PopAbooK.com Terms and Conditions and agree to have read and understood the Privacy Policy.</td></tr></table>" + "</form> </div>"; 
	}
	cartdiv.innerHTML = thehtml;
...
function getsimilarbooks(isbn13)
{
   getData1("getsimilarbooks", "isbn13=" + isbn13);
	...
	if (bookoverview != null)
		...
		headertxt = headertxt + "&nbsp;</td>";
	headertxt = headertxt + "<td width=\"33%\" align=\"center\"> <a href=\"javascript:void(0)\" onclick=\"closeblurb('" + isbn13 + "')\">Hide Similar Books</a></td><td width=\"34%\" align=\"right\">";
	if (ubcount == "0 Used Books")
	{
		headertxt = headertxt + "<span id=\"" + isbn13 + "usedbooks\" class=\"blueatp\">0 Used Books</span></td></tr></table>";
	}
	else
	{
               	ubcount = ubcount.replace("Hide ","");
		headertxt = headertxt + "<a href=\"javascript:void(0)\" id=\"" + isbn13 + "usedbooks\" class=\"blueatp\" onclick=\"getusedbooks('" + isbn13 + "')\">" + ubcount + "</a></td></tr></table>";
	}
	header.innerHTML = headertxt;
	var blurbdata = document.getElementById(isbn13 + "blurbdata");
	blurbdata.innerHTML = "<br><br><div style=\"text-align:center;\"><img src=\"https://www.popabook.com/loading.gif\"></div><br><br>";
}
function getblurb(isbn13)
{
	...
	var usedbooks = document.getElementById(isbn13 + "usedbooks");
	var ubcount = usedbooks.innerHTML;
	var headertxt = "<table width=\"100%\"> <tr><td width=\"33%\">&nbsp;<a id=\"" + isbn13 + "overview\" href=\"javascript:void(0)\" onclick=\"closeblurb('" + isbn13 + "')\" class=\"blueatp\">Hide Overview</a></td><td width=\"33%\" align=\"center\"> <a href=\"javascript:void(0)\" onclick=\"getsimilarbooks('" + isbn13 + "')\">Similar Books</a></td><td width=\"34%\" align=\"right\">";
	if (ubcount == "0 Used Books")
	{
		headertxt = headertxt + "<span id=\"" + isbn13 + "usedbooks\" class=\"blueatp\">0 Used Books</span></td></tr></table>";
	}
...
function showcart()
{
    ...
    if (items > 0)
    {
		...
		if (temp.length == 2)
			...
			thehtml = thehtml + "<td>" + "<img height=\"100px\" width=\"70px\" src=\"https://www.popabook.com/optimage/" + curr.data.image + "\" title=\"" + curr.data.title + sellinfo + "\"  onmouseover=\"this.style.cursor='pointer';\" onclick=\"getbook('getbook','book/" + isbn + "')\">" + "</td>" + "<td style=\"text-decoration:line-through\" > " + lp + "</td>" + "<td>" + op + "</td>" + "<td>" +
			...
			thehtml = thehtml + "</select>" + "</td>" + "<td>" + "<div> <a href=\"javascript:void(0)\" onclick=\"movetowishlist('" + curr.data.isbn13 + "')\"><img src=\"https://www.popabook.com/movearrow.jpg\" alt=\"Move to Wish List\" title=\"Move to Wish List\"></a>" + "</div>" + "<br><div><a href=\"javascript:void(0)\" onclick=\"removefromcart('" + curr.data.isbn13 + "')\"><img src=\"https://www.popabook.com/delete.jpg\" title=\"DELETE\"></a>" + "</div> </td>" + "</tr>"
	    	curr = curr.next;
	}
    ...
    var usave = tlp - total;
	    ...
	    thehtml = thehtml + "<br><br><div class=\"pabborder\"></div> &nbsp;<div> <a href=\"javascript:void(0)\"><img src=\"https://www.popabook.com/buttonptp.jpg\" onclick=\"getaddress(false)\"></a> </div>";
...
function showwishlist()
{
    ...
    if (items > 0)
    {
		...
		isbn = curr.data.isbn13;
				...
				thehtml = thehtml + "<tr>";
			thehtml = thehtml + "<td>" + "<img height=\"100px\" width=\"70px\" src=\"https://www.popabook.com/optimage/" + curr.data.image + "\" title=\"" + curr.data.title + "\"  onmouseover=\"this.style.cursor='pointer';\" onclick=\"getbook('getbook','book/" + isbn + "')\">" + "</td>" + "<td style=\"text-decoration:line-through\" > " + lp + "</td>" + "<td>" + op + "</td><td>";
			if (curr.data.shiptime != "Out Of Stock")
			thehtml = thehtml + "<div onmouseover=\"this.style.cursor='pointer';\" onclick=\"movetocart('" + curr.data.isbn13 + "')\">" + "<img src=\"https://www.popabook.com/movearrow.jpg\"alt=\"Move to Shopping Cart\"  title=\"Move to Shopping Cart\"></div><br>" ;
			thehtml = thehtml + "<div onmouseover=\"this.style.cursor='pointer';\" onclick=\"removefromwishlist('" + curr.data.isbn13 + "')\">" + "<img src=\"https://www.popabook.com/delete.jpg\" title=\"DELETE\">" + "</div> </td>" + "</tr>"
	    	curr = curr.next;
	}
    }
    else
...
function sellbook(frm)
{
	if (validatesellbook(frm) == false)
		return;
        var books = frm.elements[0];
	var selbook = books.options[books.selectedIndex].value;
	var input = "sellbook=" + selbook +  "&title=" + books.options[books.selectedIndex].text;
...
function loading()
{
    ...
    var width = screen.width/2 - 125 - 16;
    var thehtml = "<div style=\"position:fixed;top:200px;left:" + width + "px;\"><img src=\"https://www.popabook.com/loading.gif\"></div>";
