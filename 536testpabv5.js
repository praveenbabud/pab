...
function showcart()
{
    ...
    if (items > 0)
    {
		...
		if (temp.length == 2)
			...
			thehtml = thehtml + "</select>" + "</td>" + "<td>" + "<div> <a href=\"javascript:void(0)\" onclick=\"movetowishlist('" + curr.data.isbn13 + "')\"><img src=\"http://www.popabook.com/movearrow.jpg\" alt=\"Move to Wish List\" title=\"Move to Wish List\"></a>" + "</div>" + "<br><div><a href=\"javascript:void(0)\" onclick=\"removefromcart('" + curr.data.isbn13 + "')\"><img src=\"http://www.popabook.com/delete.jpg\" title=\"DELETE\"></a>" + "</div> </td>" + "</tr>"
	    	curr = curr.next;
	}
